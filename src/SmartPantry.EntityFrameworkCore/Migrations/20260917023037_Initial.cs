        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: false),
                    ResourceName = table.Column<string>(type: "varchar(256)", maxLength: 256, nullable: true),
                    ManagementPermissionName = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: true),
                    ParentName = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: true),
                    DisplayName = table.Column<string>(type: "varchar(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastSignInTime = table.Column<DateTimeOffset>(type: "datetime", nullable: true),
                    Leaved = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: false),
                    ExtraProperties = table.Column<string>(type: "longtext", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CreatorId = table.Column<Guid>(type: "char(36)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntityTypeFullName = table.Column<string>(type: "varchar(512)", maxLength: 512, nullable: false),
                    ExtraProperties = table.Column<string>(type: "longtext", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertyTypeFullName = table.Column<string>(type: "varchar(512)", maxLength: 512, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbpBackgroundJobs_ApplicationName_CompletionTime_IsAbandoned~",
